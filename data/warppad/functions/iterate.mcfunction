...
#Remove private warp pads if their UUID doesn't match that of the player
	execute as @a[tag=wpUsing,tag=!wpIterated,limit=1] at @e[tag=warpPad,tag=warpInTier1] unless score @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] linkedUUID matches 0 unless score @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] linkedUUID = @s linkedUUID run tag @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] remove warpInTier1
	execute as @a[tag=wpUsing,tag=!wpIterated,limit=1] at @e[tag=warpPad,tag=warpInTier2] unless score @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] linkedUUID matches 0 unless score @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] linkedUUID = @s linkedUUID run tag @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] remove warpInTier2
	execute as @a[tag=wpUsing,tag=!wpIterated,limit=1] at @e[tag=warpPad,tag=warpInTier3] unless score @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] linkedUUID matches 0 unless score @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] linkedUUID = @s linkedUUID run tag @e[tag=warpPad,distance=..0.1,limit=1,sort=nearest] remove warpInTier3
