...
#Legacy Private Warp Pad Fix
	execute if entity @e[tag=warpPad,scores={linkedUUIDL=1..,linkedUUIDM=1..}] run function warppad:creation/legacydel
#Level 1 Warp Pad
	...
	execute as @e[tag=warpPad1] at @s unless block ~ ~-1 ~ gold_block unless score @s linkedUUID matches 0 run summon item ~ ~-1 ~ {Item:{id:"minecraft:diamond",Count:1b},PickupDelay:25s}
...
#Level 2 Warp Pad
	...
	execute as @e[tag=warpPad2] at @s unless block ~ ~-1 ~ emerald_block unless score @s linkedUUID matches 0 run summon item ~ ~-1 ~ {Item:{id:"minecraft:diamond",Count:1b},PickupDelay:25s}
...
#Level 3 Warp Pad
	...
	execute as @e[tag=warpPad3] at @s unless block ~ ~-1 ~ diamond_block unless score @s linkedUUID matches 0 run summon item ~ ~-1 ~ {Item:{id:"minecraft:diamond",Count:1b},PickupDelay:25s}
