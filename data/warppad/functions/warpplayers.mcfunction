...
#Teleport and align each "passenger"
	...
	execute as @e[tag=wp.activePass,scores={wp.passXoffset=..-1}] at @s run function warppad:realignx
	execute as @e[tag=wp.activePass,scores={wp.passXoffset=1..}] at @s run function warppad:realignx
	execute as @e[tag=wp.activePass,scores={wp.passZoffset=..-1}] at @s run function warppad:realignz
	execute as @e[tag=wp.activePass,scores={wp.passZoffset=1..}] at @s run function warppad:realignz