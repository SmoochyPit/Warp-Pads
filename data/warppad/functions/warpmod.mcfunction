...
#private warp
	scoreboard players set @s modSucc 0
	execute align xyz at @e[type=item,limit=1,sort=nearest,dx=0,dy=0,dz=0] if data entity @e[type=item,nbt={Item:{id:"minecraft:diamond",Count:1b}},limit=1,sort=nearest,distance=..0.1] Thrower.L if score @s linkedUUIDL matches 0 store success score @s modSucc store result score @s linkedUUIDL run data get entity @e[type=item,nbt={Item:{id:"minecraft:diamond",Count:1b}},limit=1,sort=nearest,dx=0,dy=0,dz=0] Thrower.L 0.0000000001
	execute align xyz at @e[type=item,limit=1,sort=nearest,dx=0,dy=0,dz=0] if data entity @e[type=item,nbt={Item:{id:"minecraft:diamond",Count:1b}},limit=1,sort=nearest,distance=..0.1] Thrower.L if score @s modSucc matches 1 store result score @s linkedUUIDM run data get entity @e[type=item,nbt={Item:{id:"minecraft:diamond",Count:1b}},limit=1,sort=nearest,dx=0,dy=0,dz=0] Thrower.M 0.0000000001
	execute align xyz at @e[type=item,limit=1,sort=nearest,dx=0,dy=0,dz=0] if data entity @e[type=item,nbt={Item:{id:"minecraft:diamond",Count:1b}},limit=1,sort=nearest,distance=..0.1] Thrower.L if score @s modSucc matches 1 at @e[type=item,limit=1,sort=nearest,dx=0,dy=0,dz=0] run particle witch ~ ~ ~ 0 0 0 0.2 25
	execute align xyz at @e[type=item,limit=1,sort=nearest,dx=0,dy=0,dz=0] if data entity @e[type=item,nbt={Item:{id:"minecraft:diamond",Count:1b}},limit=1,sort=nearest,distance=..0.1] Thrower.L if score @s modSucc matches 1 run advancement grant @a[distance=..8,advancements={warppad:warppriv=false}] only warppad:warppriv
	execute align xyz at @e[type=item,limit=1,sort=nearest,dx=0,dy=0,dz=0] if data entity @e[type=item,nbt={Item:{id:"minecraft:diamond",Count:1b}},limit=1,sort=nearest,distance=..0.1] Thrower.L if score @s modSucc matches 1 run kill @e[type=item,limit=1,sort=nearest,distance=..0.1]
