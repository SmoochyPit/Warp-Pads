...
advancement grant @a[distance=..8,advancements={smoochypit:warppad/mods/rename=false}] only smoochypit:warppad/mods/rename
title @a[distance=..8,tag=!global.ignore.gui] actionbar {"text":"Warp Pad renamed to ","color":"dark_purple", "extra":[{"selector":"@s"}]}
