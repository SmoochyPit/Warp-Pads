...
advancement grant @a[distance=..8,advancements={smoochypit:warppad/warppriv=false}] only smoochypit:warppad/warppriv
title @a[distance=..8,tag=!global.ignore,tag=!global.ignore.gui,scores={wp.guitimer=0}] actionbar {"text":"Warp Pad set to Private","color":"dark_purple"}
title @a[distance=..8,tag=!global.ignore,scores={wp.guitimer=1..}] actionbar {"text":"Warp Pad set to Private","color":"dark_purple"}
