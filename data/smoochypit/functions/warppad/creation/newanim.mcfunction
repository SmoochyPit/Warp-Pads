...
#Main
	execute as @e[scores={wp.spawnAnim=1..}] at @s run function warppad:creation/newanim/1-
	execute as @e[scores={wp.spawnAnim=1..50}] at @s run function warppad:creation/newanim/1-50
	execute as @e[scores={wp.spawnAnim=50}] at @s align xyz run function warppad:creation/newanim/50
	execute as @e[scores={wp.spawnAnim=1..98}] at @s unless entity @s[nbt={Item:{Count:1b}}] run scoreboard players set @s wp.spawnAnim 0
	execute as @e[scores={wp.spawnAnim=99}] at @s run function warppad:creation/newanim/99
