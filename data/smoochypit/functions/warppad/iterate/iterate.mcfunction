...
#For every player using a warp pad, run iterate2
	...
	execute as @a[tag=wp.using,tag=!wp.iterated,limit=1] at @s if entity @e[tag=wp.pad,distance=..1] at @e[tag=wp.pad1,distance=..1,limit=1] run function smoochypit:warppad/iterate/warp1
	execute as @a[tag=wp.using,tag=!wp.iterated,limit=1] at @s if entity @e[tag=wp.pad,distance=..1] at @e[tag=wp.pad2,distance=..1,limit=1] run function smoochypit:warppad/iterate/warp2
	execute as @a[tag=wp.using,tag=!wp.iterated,limit=1] at @s if entity @e[tag=wp.pad,distance=..1] at @e[tag=wp.pad3,distance=..1,limit=1] run function smoochypit:warppad/iterate/warp3
	tag @a[tag=wp.using,tag=!wp.iterated,limit=1] add wp.iterated

#Again for each player who needs it fam
	execute if entity @a[tag=wp.using,tag=!wp.iterated] run function smoochypit:warppad/iterate/iterate